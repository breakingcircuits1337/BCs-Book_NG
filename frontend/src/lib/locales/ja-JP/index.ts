export const jaJP = {
  ...
  media: {
    title: "メディア生成",
    desc: "音楽、動画、またはその両方を生成 — 最適なプロバイダーに自動ルーティング。",
    providersLabel: "プロバイダー：",
    configured: "設定済み",
    notConfigured: "未設定",
    styleLabel: "スタイル",
    stylePlaceholder: "シネマティック、アンビエント、アップビート…",
    durationLabel: "長さ（秒）",
    generateMusic: "音楽を生成",
    generateVideo: "動画を生成",
    generateBoth: "音楽 + 動画を生成",
    enterPrompt: "生成前にプロンプトを入力してください。",
    enterBothPrompts: "動画と音楽のプロンプトを両方入力してください。",
    jobsTitle: "ジョブ一覧",
    musicTab: "音楽",
    videoTab: "動画",
    combinedTab: "結合",
    noMusicJobs: "音楽ジョブがありません。上で生成してください。",
    noVideoJobs: "動画ジョブがありません。上で生成してください。",
    noCombinedJobs: "結合ジョブがありません。上で生成してください。",
    statusPending: "保留中",
    statusRunning: "処理中",
    ...
    failedToDelete: "ジョブの削除に失敗しました",
    generationStarted: "生成を開始しました",
    failedToGenerate: "生成ジョブの送信に失敗しました",
  },
  settings: {
  ...
  advanced: {
    ...
    rebuild: {
      ...
      startNew: "新しい再構築を開始",
      itemsProcessed: "{processed}/{total}件処理済み（{percent}%）",
      failedItems: "{count}件のアイテムの処理に失敗しました",
      time: "経過時間",
