export const zhCN = {
  ...
  media: {
    title: "媒体生成",
    desc: "生成音乐、视频或两者兼有——自动路由到最佳提供商。",
    providersLabel: "提供商：",
    configured: "已配置",
    notConfigured: "未配置",
    styleLabel: "风格",
    stylePlaceholder: "电影感、环境音、活泼…",
    durationLabel: "时长（秒）",
    generateMusic: "生成音乐",
    generateVideo: "生成视频",
    generateBoth: "生成音乐 + 视频",
    enterPrompt: "生成前请输入提示词。",
    enterBothPrompts: "请同时输入视频提示词和音乐提示词。",
    jobsTitle: "我的任务",
    musicTab: "音乐",
    videoTab: "视频",
    combinedTab: "合并",
    noMusicJobs: "暂无音乐任务。请在上方生成一个。",
    noVideoJobs: "暂无视频任务。请在上方生成一个。",
    noCombinedJobs: "暂无合并任务。请在上方生成一个。",
    statusPending: "待处理",
    statusRunning: "处理中",
    statusSubmitted: "已提交",
    statusCompleted: "已完成",
