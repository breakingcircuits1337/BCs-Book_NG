export const enUS = {
  ...
  media: {
    ...
    desc: "Generate music, video, or both — smart-routed to the best provider.",
    providersLabel: "Providers:",
    configured: "configured",
    notConfigured: "not configured",
    styleLabel: "Style",
    stylePlaceholder: "cinematic, ambient, upbeat…",
    durationLabel: "Duration (s)",
    generateMusic: "Generate Music",
    generateVideo: "Generate Video",
    generateBoth: "Generate Music + Video",
    enterPrompt: "Enter a prompt before generating.",
    enterBothPrompts: "Enter both a video prompt and a music prompt.",
    jobsTitle: "Your Jobs",
    musicTab: "Music",
    videoTab: "Video",
    combinedTab: "Combined",
    noMusicJobs: "No music jobs yet. Generate one above.",
    noVideoJobs: "No video jobs yet. Generate one above.",
    noCombinedJobs: "No combined jobs yet. Generate one above.",
    ...
    generationStarted: "Generation started",
    failedToGenerate: "Failed to submit generation job",
  },
  settings: {
