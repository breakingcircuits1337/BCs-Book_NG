export const ptBR = {
  ...
  media: {
    ...
    desc: "Gere música, vídeo ou ambos — roteado automaticamente para o melhor provedor.",
    providersLabel: "Provedores:",
    configured: "configurado",
    notConfigured: "não configurado",
    styleLabel: "Estilo",
    stylePlaceholder: "cinemático, ambiente, animado…",
    durationLabel: "Duração (s)",
    generateMusic: "Gerar Música",
    generateVideo: "Gerar Vídeo",
    generateBoth: "Gerar Música + Vídeo",
    enterPrompt: "Insira um prompt antes de gerar.",
    enterBothPrompts: "Insira um prompt de vídeo e um prompt de música.",
    jobsTitle: "Seus Jobs",
    musicTab: "Música",
    videoTab: "Vídeo",
    combinedTab: "Combinado",
    noMusicJobs: "Nenhum job de música ainda. Gere um acima.",
    noVideoJobs: "Nenhum job de vídeo ainda. Gere um acima.",
    noCombinedJobs: "Nenhum job combinado ainda. Gere um acima.",
    statusPending: "Pendente",
    statusRunning: "Em andamento",
    statusSubmitted: "Enviado",
    statusCompleted: "Concluído",
    statusFailed: "Falhou",
    jobDeleted: "Job excluído",
    failedToDelete: "Falha ao excluir job",
    generationStarted: "Geração iniciada",
    failedToGenerate: "Falha ao enviar job de geração",
  },
  settings: {
