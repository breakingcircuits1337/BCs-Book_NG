export const zhTW = {
  ...
  media: {
    title: "媒體生成",
    desc: "生成音樂、影片或兩者兼有——自動路由到最佳提供商。",
    providersLabel: "提供商：",
    configured: "已設定",
    notConfigured: "未設定",
    styleLabel: "風格",
    stylePlaceholder: "電影感、環境音、活潑…",
    durationLabel: "時長（秒）",
    generateMusic: "生成音樂",
    generateVideo: "生成影片",
    generateBoth: "生成音樂 + 影片",
    enterPrompt: "生成前請輸入提示詞。",
    enterBothPrompts: "請同時輸入影片提示詞和音樂提示詞。",
    jobsTitle: "我的任務",
    musicTab: "音樂",
    videoTab: "影片",
    combinedTab: "合併",
    noMusicJobs: "暫無音樂任務。請在上方生成一個。",
    noVideoJobs: "暫無影片任務。請在上方生成一個。",
    noCombinedJobs: "暫無合併任務。請在上方生成一個。",
    statusPending: "待處理",
    statusRunning: "處理中",
    statusSubmitted: "已提交",
    statusCompleted: "已完成",
    statusFailed: "失敗",
    jobDeleted: "任務已刪除",
    failedToDelete: "刪除任務失敗",
    generationStarted: "生成已開始",
    failedToGenerate: "提交生成任務失敗",
  },
  settings: {
